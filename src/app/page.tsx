...
export default function Home() {
  ...
  return (
    <div style={{ display: 'flex', height: '100vh' }}>
      ...
      >
        {isSidebarOpen && <PromptLibrary />} {/* Render PromptLibrary in sidebar */}
      </div>
      ...
      <div style={{ flexGrow: 1, position: 'relative' }}>
        ...
        <ChatInterface role={role} program={program} setRole={setRole} setProgram={setProgram} onReset={handleReset} />
      </div>
    </div>
  );
}
