...
export async function POST(r: Request) {
  ...
  try {
    ...
    if (d.kind === "scope-sequence" && parsed.sequence?.years !== (d.years || programYears[d.profile.program])) throw new ApiError(502,"The draft did not cover the requested programme years. Try again.");
